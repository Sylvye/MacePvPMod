...
public final class SurvivalConfigStore {
    ...
    public void load() {
        ...
        try {
            ...
            try {
                Path backup = Files.createTempFile(path.toAbsolutePath().getParent(), "sylvyespvphud-survival-invalid-", ".json");
    ...
    public void save(SurvivalConfig next) throws IOException {
        ...
        Path temporary = Files.createTempFile(parent, "sylvyespvphud-", ".tmp");
        try {
