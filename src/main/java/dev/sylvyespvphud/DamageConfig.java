...
public record DamageConfig(int schemaVersion, boolean fallEnabled, int fallColor, double fallSize,
        ...
        boolean trackerEnabled, int trackerSeconds, String trackerTemplate,
        int trackerHudSeconds, boolean trackerHudAlwaysVisible) {
    private static final String DEFAULT_TRACKER_TEMPLATE="{player}: {damage} total damage";
    ...
    public DamageConfig(int schemaVersion, boolean fallEnabled, int fallColor, double fallSize,
        ...
        this(2,fallEnabled,fallColor,fallSize,fallX,fallY,hitEnabled,hitColor,hitSize,hitX,hitY,hitSeconds,calculatedDamage,fallTemplate,hitTemplate,fallThreshold,fallColors,hitColors,maceEnabled,spearEnabled,swordAxeEnabled,useEnemyGear,boldCriticalDamage,true,true,60,DEFAULT_TRACKER_TEMPLATE,5,false);
    }
    public DamageConfig(int schemaVersion, boolean fallEnabled, int fallColor, double fallSize,
            int fallX, int fallY, boolean hitEnabled, int hitColor, double hitSize, int hitX, int hitY, int hitSeconds, boolean calculatedDamage, String fallTemplate, String hitTemplate, double fallThreshold,
            ColorScale fallColors, ColorScale hitColors, boolean maceEnabled, boolean spearEnabled,
            boolean swordAxeEnabled, boolean useEnemyGear, boolean boldCriticalDamage,boolean enabled) {
        this(2,fallEnabled,fallColor,fallSize,fallX,fallY,hitEnabled,hitColor,hitSize,hitX,hitY,hitSeconds,calculatedDamage,fallTemplate,hitTemplate,fallThreshold,fallColors,hitColors,maceEnabled,spearEnabled,swordAxeEnabled,useEnemyGear,boldCriticalDamage,enabled,true,60,DEFAULT_TRACKER_TEMPLATE,5,false);
    }
    public DamageConfig(int schemaVersion, boolean fallEnabled, int fallColor, double fallSize,
        ...
        this(2,fallEnabled,fallColor,fallSize,fallX,fallY,hitEnabled,hitColor,hitSize,hitX,hitY,
                ...
                maceEnabled,spearEnabled,swordAxeEnabled,useEnemyGear,true,true,true,60,DEFAULT_TRACKER_TEMPLATE,5,false);
    }
    public DamageConfig(int schemaVersion, boolean fallEnabled, int fallColor, double fallSize,
            int fallX, int fallY, boolean hitEnabled, int hitColor, double hitSize, int hitX, int hitY,
            int hitSeconds, boolean calculatedDamage, String fallTemplate, String hitTemplate,
        ...
        this(2, fallEnabled, fallColor, fallSize, fallX, fallY, hitEnabled, hitColor, hitSize,
                ...
                fallColors, hitColors, true, true, false, false, true, true,true,60,DEFAULT_TRACKER_TEMPLATE,5,false);
    }
    public DamageConfig(int schemaVersion, boolean fallEnabled, int fallColor, double fallSize,
    ...
    public DamageConfig validated() {
        ...
        return new DamageConfig(2, fallEnabled, clamp(fallColor, 0, 0xffffff), size(fallSize),
                ...
                trackerEnabled,clamp(trackerSeconds,1,300),trackerTemplate(trackerTemplate),clamp(trackerHudSeconds,1,300),trackerHudAlwaysVisible);
    }
    ...
    private static String trackerTemplate(String s){return s!=null&&s.length()<=160&&CumulativeDamageText.error(s).isEmpty()?s:DEFAULT_TRACKER_TEMPLATE;}
